...
public class ClientMoreFragment extends BaseFragment {
    ...
    @OnClick({R.id.fragment_more_btn_offer, R.id.fragment_more_btn_connect_us, R.id.fragment_more_btn_about_app, R.id.fragment_more_btn_change_pass, R.id.fragment_more_btn_log_out})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.fragment_more_btn_offer:
                OfferListFragment offerListFragment = new OfferListFragment();
                replace(offerListFragment, getActivity().getSupportFragmentManager(), R.id.activity_home_fl_frame, null, null);
                break;
            ...
            case R.id.fragment_more_btn_about_app:
                ...
                break;
            case R.id.fragment_more_btn_change_pass:
